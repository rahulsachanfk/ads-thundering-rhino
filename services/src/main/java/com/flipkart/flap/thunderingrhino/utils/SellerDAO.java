...
import com.flipkart.flap.thunderingrhino.entities.SellerReport;
...
@RegisterMapper(SellerReport.SellerReportMapper.class)
public interface SellerDAO {
    ...
    @SqlQuery(
            "select  \n" +
                    ...
                    "bannerid,listing_id,impressions,clicks,conversions,Revenue,\n" +
                    ...
                    ") t\n" +
                    "group by \n" +
                    "seller_name,seller_id,`campaign_id`,name,`status`,`ox_campaign_id`,`budget_currency`,`budget_value`,`start_date`,`end_date`,`rate_id`,`bannerid`,`listing_id`,`impressions`,`clicks`)  final"
    )
    Iterator<SellerReport> findSellerReportById(@Bind("id") String id);
}
